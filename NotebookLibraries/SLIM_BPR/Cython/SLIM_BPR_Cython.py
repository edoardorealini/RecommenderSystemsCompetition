...
from NotebookLibraries.Base.Recommender_utils import check_matrix
from NotebookLibraries.Base.BaseSimilarityMatrixRecommender import BaseSimilarityMatrixRecommender
from NotebookLibraries.Base.Recommender_utils import similarityMatrixTopK
...
class SLIM_BPR_Cython(BaseSimilarityMatrixRecommender, Incremental_Training_Early_Stopping):
    ...
    def fit(self, epochs=300,
        ...
        from NotebookLibraries.SLIM_BPR.Cython.SLIM_BPR_Cython_Epoch import SLIM_BPR_Cython_Epoch

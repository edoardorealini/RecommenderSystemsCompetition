...
from NotebookLibraries.Data_manager.Movielens20M.Movielens20MReader import _loadICM_genres, _loadURM_preinitialized_item_id
...
def _loadUCM(UCM_path, header=True, separator=','):
    ...
    # Genres
    from NotebookLibraries.Data_manager.IncrementalSparseMatrix import IncrementalSparseMatrix_FilterIDs
